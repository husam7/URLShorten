...
function NavMenu() {
    function myFunction() {
        ...
        var a = document.getElementById("Alogin");
        var itemList = document.getElementById("MyTopNav");
        if (itemList.className === "NavMenu") {
          itemList.className += " responsive";
          itemList.appendChild(btn);
          itemList.appendChild(a);
        } else {
          var ButtonCol =  document.getElementById("ButtonCol");
  ...
  return (
    <Container className='NavMenu' fluid={true}>
    <Row>
      <Col className="Svg" xs={12} sm={2} md={2} lg={2}>
      <svg xmlns="http://www.w3.org/2000/svg" width="120" height="32">
      <path fill="#34313D" d={x}/>
      </svg>
      <a className="Icon" onClick={myFunction}>
      <i className="fa fa-bars Ic"></i></a>
      </Col>
      <Col sm={6} md={5} lg={6} >
      <div className="NavMenu" id="MyTopNav">
      <a className="Item" href="#features">Features</a>
      <a className="Item" href="#pricing">Pricing</a>
      <a className="Item" href="#resources">Resources</a>
      </div>
      </Col>
      <Col sm={4} md={5} lg={4} fluid='lg' >
      <span className="SBtn" id="Span">
      <Row>
      <Col sm={6} md={6} lg={6} fluid="true" id="ButtonCol">
      <button id="Btn" className='Button'>SignUp</button>
      </Col> 
      <Col sm={6} md={6} lg={6} fluid="true" id="ACol">
